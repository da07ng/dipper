   ...
   ({
    ...
    idinfo: {
      ...
      keywords: {
        ...
        stratum: "Estrato",
        temporal: "Temporal",
        thesaursus: "Léxico Associado",
        delimited: "Keywords",
        themektIsoTopicCategory: "Tópico ISO...",
        themektIsoTopicDialog: "Tópico ISO",
        placektGnis: "Sistema de Informação de Nomes Geográficos"
      },
      accconst: "Restrições de acesso",
      useconst: "Utilize restrições",
      ptcontac: "Ponto de Contato para o Recurso",
      browse: {
      ...
      datacred: "Conjunto de Dados de Crédito",
      secinfo: {
      ...
      sNative: "Ambiente de Conjunto de Dados Nativos",
    ...
    metainfo: {
      ...
      metd: "Data Metadados",
      metrd: "Data da avaliação Metadados",
      metfrd: "Data de Futura Revisão Metadados",
      metstdn: "Nome Standard Metadados",
      metstdv: "Versão Standard dos Metadados",
      metac: "Restrições de Acesso Metadados",
      metuc: "Uso de Restrições Metadados",
      metsi: {
