define(["../../../../core/declare",
        ...
        "../tools/geoExtentUtil",
        "../../../../kernel"],
function(declare, lang, array, query, registry, domConstruct, has,
         ClickableTool, GeoExtentDialog, GeoExtentView, geoExtentUtil, esriKernel) {
  ...
  var oThisClass = declare([ClickableTool], {
    ...
    _handleRequest: function(inputWidget, bWasClick) {
      if(!inputWidget || !inputWidget.parentXNode) return;
      ...
      var westWgt = this._findInputWgt("/metadata/idinfo/spdom/bounding/westbc", node);
      var eastWgt = this._findInputWgt("/metadata/idinfo/spdom/bounding/eastbc", node);
      var northWgt = this._findInputWgt("/metadata/idinfo/spdom/bounding/northbc", node);
      var southWgt = this._findInputWgt("/metadata/idinfo/spdom/bounding/southbc", node);
