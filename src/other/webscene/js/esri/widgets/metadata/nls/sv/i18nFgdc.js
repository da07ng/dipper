   ...
   ({
    ...
    idinfo: {
      ...
      keywords: {
        ...
        place: "Plats",
        stratum: "Stratum",
        temporal: "Tidsbestämning",
        thesaursus: "Associerad synonymordlista",
        delimited: "Nyckelord",
        themektIsoTopicCategory: "ISO-ämne...",
        themektIsoTopicDialog: "ISO-ämne",
        placektGnis: "Geographic Names Information System"
      },
      accconst: "Åtkomstbegränsningar",
      useconst: "Användningsbegränsningar",
      ptcontac: "Kontaktpunkt för resursen",
      browse: {
      ...
      datacred: "Utvecklare av datauppsättning",
      secinfo: {
      ...
      sNative: "Ursprunglig datasuppsättningsmiljö",
    ...
    metainfo: {
      ...
      metd: "Metadatadatum",
      metrd: "Datum för metadatagranskning",
      metfrd: "Datum för framtida metadatagranskning",
      metstdn: "Namn på metadatastandard",
      metstdv: "Metadatastandardens version",
      metac: "Åtkomstbegränsningar för metadata",
      metuc: "Begränsningar för metadataanvändning",
      metsi: {
